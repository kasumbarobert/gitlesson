...
void reset2mNodeStruct();
void resetGroundNodeStruct();
void resetSinkNodeStruct();
void reset10mNodeStruct();
MYSQL *connect2db();
                    ...
                    if(recvMsgSize>0){
                       // fprintf(fp,"%s",buffer);
                        ...
                        if(strstr(buffer,TEN_M_KEY)!=NULL){
                            ...
                            resetGroundNodeStruct();//clear all the values in the structure for the ground node
                            }
